...
const ProfileDetailsLeftCol = (props: { vo: Profile | null | undefined }) => {
  return (
    <div className="card text-bg-dark border-0 mb-4">
      ...
      >
        <h5 className="card-title mt-5 pt-2">{props.vo?.basic.display_name}</h5>
        ...
        <div className="text-center">
          <button className="btn btn-success rounded-pill px-5" type="button">
            <svg
...
ProfileDetailsLeftCol.propTypes = {
  vo: any,
};

export default ProfileDetailsLeftCol;
